              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: const [
                            Icon(Icons.arrow_downward_rounded, color: redAccent, size: 16),
                            SizedBox(width: 6),
                            Text(
                              'Pengeluaran',
                              style: TextStyle(
                    ...
                    // Inactive Pemasukan Tab
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          // Slide transition / Replace named route
                          Navigator.pushReplacementNamed(context, '/catat_pemasukan');
                        },
                        child: Container(
                          height: 46,
                          decoration: BoxDecoration(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: const [
                              Icon(Icons.arrow_upward_rounded, color: textGrey, size: 16),
                              SizedBox(width: 6),
                              Text(
                                'Pemasukan',
                                style: TextStyle(
